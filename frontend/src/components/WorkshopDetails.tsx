...
const WorkshopDetails: React.FC = () => (
  <>
    ...
    {/* Marquee Section */}
    <section className="py-16 sm:py-20 bg-brand-surface border-y border-brand-border">
      <div className="space-y-6">
        {/* Top Marquee - AI Journey */}
        <div className="overflow-hidden">
          <TextMarquee
            baseVelocity={-3}
            className="text-4xl sm:text-5xl lg:text-6xl font-bold text-brand-dark"
            delay={0}
          >
        ...
        {/* Bottom Marquee - Robotics Journey */}
        <div className="overflow-hidden">
          <TextMarquee
            baseVelocity={3}
            className="text-4xl sm:text-5xl lg:text-6xl font-bold text-brand-blue"
            delay={200}
          >
