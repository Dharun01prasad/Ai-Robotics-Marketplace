  ...
  return (
    <ReactLenis root>
      <main className='transition-colors duration-100' ref={container} style={{ backgroundColor: bgColor }}>
        ...
        <section className='w-full transition-colors duration-100' ref={sectionRef} style={{ backgroundColor: bgColor }}>
          {learningOutcomes.map((outcome, i) => {
            const targetScale = 1 - (learningOutcomes.length - i) * 0.05;
            return (
              <OutcomeCard
        ...
        <footer className='border-t border-brand-border py-16 transition-colors duration-100' style={{ backgroundColor: bgColor }}>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 text-center'>
            ...
            <p className='transition-colors duration-100' style={{ color: subtextColor }}>Start your AI and robotics journey with Kidrove today.</p>
          </div>
        </footer>
      </main>
    </ReactLenis>
